class Categoria {
  ...
  static List<Categoria> list = [
    ...
    Categoria('Monogénicas o mendelianas', 'url', [
      Enfermedad(
...
class Enfermedad {
  ...
  Enfermedad(this.nombre, this.subcategoria, this.resumen, this.imagen);
}
